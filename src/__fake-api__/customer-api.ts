...
type GetCustomersResponse = Promise<Customer[]>;
...
class CustomerApi {
  ...
  getCustomerEmails(
    request?: GetCustomerEmailsRequest
  ): GetCustomerEmailsResponse {
  ...
  getCustomerLogs(request?: GetCustomerLogsRequest): GetCustomerLogsResponse {
