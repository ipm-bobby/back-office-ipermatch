  ...
  cards: [
    {
      ...
      cover: "/mock-images/kanban/media_1.jpg",
      description:
...
type CreateCardResponse = Promise<Card>;
...
type UpdateCardResponse = Promise<Card>;
...
type MoveCardResponse = Promise<true>;

type DeleteCardRequest = {
  cardId: string;
};

type DeleteCardResponse = Promise<true>;
...
class KanbanApi {
  ...
  createCard(request: CreateCardRequest): CreateCardResponse {
  ...
  updateCard(request: UpdateCardRequest): UpdateCardResponse {
  ...
  moveCard(request: MoveCardRequest): MoveCardResponse {
  ...
  deleteCard(request: DeleteCardRequest): DeleteCardResponse {
